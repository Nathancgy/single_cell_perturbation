...
import numpy as np
import json
from CNN_pipeline import combine_features, load_trained_models, average_prediction, weighted_average_prediction
...
if __name__ == "__main__":
    ...
    chemberta_type = test_config.get("CHEMBERTA_TYPE", "MLM")
